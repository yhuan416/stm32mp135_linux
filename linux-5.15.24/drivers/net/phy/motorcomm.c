...
/* for ALIENTEK YT8531 led show*/
#define ALIENTEK_YT8531_LED_SHOW			1
...
//	ret = ytphy_write_ext(phydev, 0xa012, 0xc8);  //alientek change
	ret = ytphy_write_ext(phydev, 0xa012, 0xd0);  //alientek add
	if (ret < 0)
		return ret;
...
#if ALIENTEK_YT8531_LED_SHOW
	ytphy_write_ext(phydev, 0xa00d, 0x2600);//yellow led blink
	ytphy_write_ext(phydev, 0xa00c, 0x30);	//10_100M green led always light
	ytphy_write_ext(phydev, 0xa00e, 0x40);	//1000M green led always light
#endif	
